                ...
                <div className="flex">
                  ...
                  <div className="text-left [&>div>input]:rounded-lg [&>div>input]:bg-gray-200 [&>div>input]:p-2 [&>div>input]:shadow-inner [&>div]:mb-2 [&>div]:pr-5">
                    <div className="mt-5">
                      ...
                      <input type="text" id="modal-Nm" className="w-full" defaultValue={props.entity?.Dbtr.Nm} value={customEntity?.Dbtr.Nm}
                        onChange={(e) => {
                    ...
                    <div>
                      ...
                      <input type="text" id="modal-CityOfBirth" className="w-full" defaultValue={props.entity?.Dbtr.Id.PrvtId.DtAndPlcOfBirth.CityOfBirth} value={customEntity?.Dbtr.Id.PrvtId.DtAndPlcOfBirth.CityOfBirth}
                        onChange={(e) => {
                          if (customEntity !== undefined) {
                            setCustomEntity({
                              ...customEntity,
                    ...
                    <div>
                      ...
                      <input type="text" id="modal-CtryOfBirth" className="w-full" defaultValue={props.entity?.Dbtr.Id.PrvtId.DtAndPlcOfBirth.CtryOfBirth} value={customEntity?.Dbtr.Id.PrvtId.DtAndPlcOfBirth.CtryOfBirth}
                        onChange={(e) => {
                          if (customEntity !== undefined) {
                            setCustomEntity({
                              ...customEntity,
                    ...
                    <div>
                      ...
                      <input type="text" id="modal-MobNb" className="w-full" defaultValue={props.entity?.Dbtr.CtctDtls.MobNb} value={customEntity?.Dbtr.CtctDtls.MobNb}
                        onChange={(e) => {
                          if (customEntity !== undefined) {
                            setCustomEntity({
                              ...customEntity,
                ...
                <div className="flex flex-col">
                  {accountDetails.map((accountDetail, index) => (
                    ...
                    <div className="flex">
                      ...
                      <div className="text-left [&>div>input]:rounded-lg [&>div>input]:bg-gray-200 [&>div>input]:p-2 [&>div>input]:shadow-inner [&>div]:mb-2 [&>div]:pr-5" key={index}>
                        <div className="mt-5">
                        ...
                        <div>
                          ...
                          <input type="text" id={`modal-Account-ID-${index}`} className="w-full" defaultValue={props.entity?.Dbtr.Id.PrvtId.Othr[0]?.Id} value={accountDetail.DbtrAcct.Id.Othr[0]?.Id} readOnly />
                        </div>
                        <div>
