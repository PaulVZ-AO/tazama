        ...
        <div className="flex min-h-full items-end justify-center p-4 sm:items-center sm:p-0">
          <div className="relative min-w-[470px] overflow-hidden rounded-lg bg-gray-200 p-5">
            <div className="flex flex-col justify-between">
              ...
              <button className="absolute right-5 rounded-full bg-gradient-to-r from-gray-200 to-gray-100 p-1 shadow-[0.625rem_0.625rem_0.875rem_0_rgb(225,226,228),-0.5rem_-0.5rem_1.125rem_0_rgb(255,255,255)]" onClick={handleCancel}>
            ...
            <div className="text-left [&>div>input]:rounded-lg [&>div>input]:bg-gray-200 [&>div>input]:p-2 [&>div>input]:shadow-inner [&>div]:mb-2 [&>div]:px-5">
              <div className="mt-5">
                ...
                <input type="text" className="w-full" value={props.formValues.amount} onChange={(e) => handleDecimalChange(e, "amount", 5)} maxLength={18} />
              ...
              <div className="mt-5 flex flex-row gap-[20px] [&>div>input]:rounded-lg [&>div>input]:bg-gray-200 [&>div>input]:p-2 [&>div>input]:shadow-inner">
                <div>
                  ...
                  <input type="number" className="w-full" value={props.formValues.latitude} onChange={(e) => handleNumberChange(e, "latitude")} min={-90} max={90} step="any" />
                  {errors.latitude && <p className="text-red-500">{errors.latitude}</p>}
                </div>
                <div>
                  <label htmlFor="modal-Longitude">Longitude</label>
                  <input type="number" className="w-full" value={props.formValues.longitude} onChange={(e) => handleNumberChange(e, "longitude")} min={-90} max={90} step="any" />
            ...
            <div className="flex">
              ...
              <button type="button" className="m-5 w-full rounded-lg bg-gradient-to-r from-gray-200 to-gray-100 py-2 shadow-inner" onClick={handleCancel}>Cancel</button>
            </div>
          </div>
        </div>
      </div>
