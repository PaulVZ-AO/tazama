...
const Web = () => {
  ...
  useEffect(() => {console.log("SELECTED ENTITY: ", selectedEntity)}, [selectedEntity])
  useEffect(() => {console.log("SELECTED CREDITOR ENTITY: ", selectedCreditorEntity)}, [selectedCreditorEntity])
  useEffect(() => {console.log("DEBTORS: ", entityCtx.entities)}, [entityCtx.entities])
  useEffect(() => {console.log("CREDITORS: ", entityCtx.creditorEntities)}, [entityCtx.creditorEntities])
    ...
    <div className="bg-slate-300/25 px-5 pt-10">
      <div className="grid grid-cols-12 gap-5">
        ...
        <div className="col-span-8">
          <div className="grid grid-cols-12 gap-1">
            <div className="col-span-4"><DebtorDevice selectedEntity={selectedEntity} isDebtor={true} /></div>
            <div className="col-span-4 flex items-center justify-between px-5"><ProcessIndicator /></div>
            <div className="col-span-4"><DebtorDevice selectedEntity={selectedCreditorEntity} isDebtor={false} /></div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-12 gap-5 pt-10">
        ...
        <div className="col-span-2 rounded-md shadow-[0.625rem_0.625rem_0.875rem_0_rgb(225,226,228),-0.5rem_-0.5rem_1.125rem_0_rgb(255,255,255)]">
          <h2 className="mb-5 rounded-t-lg bg-gradient-to-r from-gray-100 to-gray-200 py-5 text-center uppercase shadow-lg">Event director</h2>
          <div className="flex min-h-80 items-center justify-center"><StatusIndicator large={true} /></div>
        </div>
        ...
        <div className="col-span-4 rounded-lg shadow-[0.625rem_0.625rem_0.875rem_0_rgb(225,226,228),-0.5rem_-0.5rem_1.125rem_0_rgb(255,255,255)]">
          ...
          <div className="grid grid-cols-12">
            ...
            <div className="col-span-6 px-5"><RuleResult /></div>
          </div>
        </div>

        {/* Typologies */}
        <div className="col-span-4 rounded-lg shadow-[0.625rem_0.625rem_0.875rem_0_rgb(225,226,228),-0.5rem_-0.5rem_1.125rem_0_rgb(255,255,255)]">
          <h2 className="mb-5 rounded-t-lg bg-gradient-to-r from-gray-100 to-gray-200 py-5 text-center uppercase shadow-lg">Typologies</h2>
          <div className="grid grid-cols-12">
            <div className="col-span-6">
              <div className="grid grid-cols-3 px-5">
                {types &&
            ...
            <div className="col-span-6 px-5"><TypeResult /></div>
          </div>
        </div>
        ...
        <div className="col-span-2 rounded-lg shadow-[0.625rem_0.625rem_0.875rem_0_rgb(225,226,228),-0.5rem_-0.5rem_1.125rem_0_rgb(255,255,255)]">
          <h2 className="mb-5 rounded-t-lg bg-gradient-to-r from-gray-100 to-gray-200 py-5 text-center uppercase shadow-lg">Tadproc</h2>
          <div className="flex min-h-80 items-center justify-center"><StatusIndicator large={true} /></div>
        </div>
      </div>
