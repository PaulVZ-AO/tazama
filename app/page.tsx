...
export default function Web() {
  ...
  function RuleResult() {
    ...
    return (
      <div className="p-5 rounded-xl shadow-[0.625rem_0.625rem_0.875rem_0_rgb(225,226,228),-0.5rem_-0.5rem_1.125rem_0_rgb(255,255,255)]">
  ...
  return (
    <div className="bg-slate-300/25 px-5 pt-10">
      <div className="grid grid-cols-12 gap-5">
        ...
        <div className="col-span-8">
          <div className="grid grid-cols-12 gap-1">
            <div className="col-span-4">
              <Image src="/device.svg" height="200" width="200" className="text-center ml-auto" alt=""/>
            </div>
        ...
        <div className="col-span-2">
          <div className="p-5 shadow-[0.625rem_0.625rem_0.875rem_0_rgb(225,226,228),-0.5rem_-0.5rem_1.125rem_0_rgb(255,255,255)] rounded-lg flex flex-wrap justify-center">
            <div className="text-center mb-5 text-xl">Creditors</div>
            ...
            <div className="col-span-6">
              <div className="grid grid-cols-3 px-5">
                ...
                {rules && rules.map((rule: any) => (
                  <div
                    className={`flex mb-1 px-2 rounded-md hover:bg-gray-200 hover:shadow`}
                    key={`r-${rule.id}`}
                  >
                    <StatusIndicator /> &nbsp;
                    {rule.title}
